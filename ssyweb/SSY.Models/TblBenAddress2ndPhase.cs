...
namespace SSY.Models
{
    ...
    public partial class TblBenAddress2ndPhase
    {
        ...
        public virtual TblBeneficiary2ndPhase TblBeneficiary2ndPhase { get; set; }
        public virtual TblBeneficiary2ndPhase TblBeneficiary2ndPhase1 { get; set; }
    }
}
