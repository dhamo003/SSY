...
export class CeoDataService {
    ...
    getFundRequestedClaims(id: number, type: any, wfType: any, statusId: any, rlo: any, fundRequestNo: any, requestDate: any, pageNo?: any, pageSize?: any) {
        ...
        debugger;
        const options = new HttpRequest<any>('GET', ApiDictionary.getFundRequestedClaims.url + "/" + id + "/" + type + "/" + wfType + "/" + rlo + "/" + fundRequestNo + "/" + requestDate + "/" + pageNo + "/" + pageSize + "/" +statusId, { params: params });
    ...
    getFundRequestedClaimsById(Id: any, type: any) {
        debugger;
        let params = new HttpParams();
        const options = new HttpRequest<any>('GET', ApiDictionary.getFundRequestedClaimsById.url + "/" + Id + "/" + type, { params: params });
        return this.apiService.getDropdownData(options).map((res: any) => {
            return res;
        });
    }
    ...
    getCEOUtilizationCertificates(id: number, pageNo?: any, pageSize?: any) {
        let params = new HttpParams();
        const options = new HttpRequest<any>('GET', ApiDictionary.getCEOUtilizationCertificates.url + "/" + id + "/" + pageNo + "/" + pageSize, { params: params });
        return this.apiService.getDropdownData(options).map((res: any) => {
            return res;
        });
    }
