    ...
    public partial class UserReport : System.Web.UI.Page
    {
        ...
        protected void BindSSRS()
        {
...

            {
				...
				ReportViewer1.ServerReport.ReportPath = "/UserReport (1)"; //"/UserReport";
                ...
                {
                    if (parameters[i].Name.ToLower() == "createdby")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["createdby"].ToString(), false));
                    }
					//if (parameters[i].Name.ToLower() == "applicationtype")
					//{
					//    parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["ApplicationType"].ToString(), false));
					//}

					if (parameters[i].Name.ToLower() == "applicationtype")
					{
						parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["workerTypetext"].ToString(), false));
					}

					if (parameters[i].Name.ToLower() == "applicationtypevalue")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["AppTypeText"].ToString(), false));
                    }
                    ...
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["StatusText"].ToString(), false));
                    }
                    if (parameters[i].Name.ToLower() == "statusvalue")
                    {
