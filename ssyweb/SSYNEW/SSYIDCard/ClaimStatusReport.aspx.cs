...
{
    public partial class ClaimStatusReport : System.Web.UI.Page
    {
        ...
        protected void BindSSRS()
        {
            try
            {
                ...
                ReportViewer1.ServerReport.ReportPath = "/ClaimStatusReport";
                ...
                for (int i = 0; i < parameters.Count; i++)
                {
                    ...
                    if (parameters[i].Name.ToLower() == "workertype")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["workertype"].ToString(), false));
                    }
                    if (parameters[i].Name.ToLower() == "claimstatus")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["claimstatus"].ToString(), false));
                    }
                    if (parameters[i].Name.ToLower() == "fundstatus")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["fundstatus"].ToString(), false));
                    }
                    ...
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["location"].ToString(), false));
                    }
                    if (parameters[i].Name.ToLower() == "subdiv")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["SubDiv"].ToString(), false));
                    }
                    ...
                    if (parameters[i].Name.ToLower() == "typeofbenefit")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["typeofbenefit"].ToString(), false));
                    }
                }
