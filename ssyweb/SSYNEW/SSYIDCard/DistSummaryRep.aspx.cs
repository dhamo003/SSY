...
{
    public partial class DistSummaryRep : System.Web.UI.Page
    {
        ...
        protected void BindSSRS()
        {
            try
            {
                ...
                ReportViewer1.ServerReport.ReportPath = "/SSY_DistrictWiseSummary_Rpt";
                ...
                {
                    if (parameters[i].Name.ToLower() == "distcodes")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["senddistrict"].ToString(), false));
                    }
                    ...
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["Scheme"].ToString(), false));
                    }
