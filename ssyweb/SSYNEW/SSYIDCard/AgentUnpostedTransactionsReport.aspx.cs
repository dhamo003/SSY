...
{
    public partial class AgentUnpostedTransactionsReport : System.Web.UI.Page
    {
        ...
        protected void BindSSRS()
        {
            try
            {
                ...
                ReportViewer1.ServerReport.ReportPath = "/AgentUnpostedTransactionsReport";
                ...
                for (int i = 0; i < parameters.Count; i++)
                {
                    ...
                    if (parameters[i].Name.ToLower() == "block")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["block"].ToString(), false));
                    }
                    ...
                    if (parameters[i].Name.ToLower() == "agentno")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["agentno"].ToString(), false));
                    }
                }
