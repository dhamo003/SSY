    ...
    public partial class RegistrationReport : System.Web.UI.Page
    {
        ...
        protected void BindSSRS()
        {
            try
            {
                ...
                ReportViewer1.ServerReport.ReportPath = "/SSY_Registrations_Report";
                ...
                {
                    if (parameters[i].Name.ToLower() == "subdivi")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["subdivisions"].ToString(), false));
                    }
