    ...
    public partial class AccountStatementReport : System.Web.UI.Page
    {
...

        {
            try
            {
                ...
                ReportViewer1.ServerReport.ReportPath = "/AccountStatementReport";
                ...
                {
                    if (parameters[i].Name.ToLower() == "ssi_number")
                    {
                        parmList.Add(new ReportParameter("SSI_Number", Request.QueryString["ssi_number"].ToString(), false));
                    }
