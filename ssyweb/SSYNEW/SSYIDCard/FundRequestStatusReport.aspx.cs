...
{
    public partial class FundStatusReport : System.Web.UI.Page
    {
...

        {
            try
            {
                ...
                ReportViewer1.ServerReport.ReportPath = "/FundRequestStatusReport";
                ...
                for (int i = 0; i < parameters.Count; i++)
                {
                    ...
                    if (parameters[i].Name.ToLower() == "board")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["board"].ToString(), false));
                    }
                    if (parameters[i].Name.ToLower() == "statusid")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["statusid"].ToString(), false));
                    }
