...
{
    public partial class BeneficiariesAccountDetailsReport : System.Web.UI.Page
    {
        ...
        protected void BindSSRS()
        {
            try
            {
                ...
                ReportViewer1.ServerReport.ReportPath = "/BeneficiariesAccountDetailsReport";
                ...
                for (int i = 0; i < parameters.Count; i++)
                {
                    ...
                    if (parameters[i].Name.ToLower() == "ssinfrom")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["ssinfrom"].ToString(), false));
                    }
                    if (parameters[i].Name.ToLower() == "ssinto")
                    {
                        parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["ssinto"].ToString(), false));
                    }
                }
