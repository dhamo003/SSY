...
{
	public partial class LegacyProgressReport : System.Web.UI.Page
	{
...

		{
			try
			{
				...
				ReportViewer1.ServerReport.ReportPath = "/LegacyProgressReport";
				...
				for (int i = 0; i < parameters.Count; i++)
				{
					...
					if (parameters[i].Name.ToLower() == "isactive")
					{
						parmList.Add(new ReportParameter(parameters[i].Name.ToString(), Request.QueryString["cafid"].ToString(), false));
					}
